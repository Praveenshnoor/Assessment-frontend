        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen bg-shnoor-lavender flex flex-col items-center justify-center px-4">
                    <div className="max-w-md w-full bg-white rounded-xl shadow-[0_8px_30px_rgba(14,14,39,0.06)] p-6 sm:p-8 text-center border-t-4 border-shnoor-danger">                        <div className="w-20 h-20 mx-auto bg-shnoor-dangerLight rounded-full flex items-center justify-center mb-6">
