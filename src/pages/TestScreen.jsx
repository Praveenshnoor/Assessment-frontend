            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700">
                      The exam administrator has stopped your examination. Your current progress has been recorded and submitted.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <span className="font-semibold">Next Steps:</span> You will be redirected to provide feedback about your exam experience. 
                  If you believe this action was taken in error, please contact the examination office.
                </p>
              </div>
            </div>
